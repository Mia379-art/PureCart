 <style>
    ...
    .newmap-circle--yellow {
      ...
      position: relative;
      flex-shrink: 0;
      box-shadow: 0 0 0 10px rgba(255,119,0,0.3);
      animation: pulseBorder 1s ease-out infinite;
    }

    @keyframes pulseBorder {
      0% {
        box-shadow: 0 0 0 0 rgba(255, 119, 0, 0.3);
      }
      70% {
  ...
  <section class="newmap-section">

    <!-- مرحله ۱ -->
    <div class="newmap-item newmap-item--step1">
      <div class="newmap-circle newmap-circle--yellow">
          <span class="newmap-icon">
          ...
          <span class="newmap-badge">۱</span>
      </div>
    
      <div class="newmap-card newmap-card--top">
    ...
    <!-- مرحله ۲ -->
    <div class="newmap-item newmap-item--step2">
      <div class="newmap-circle newmap-circle--yellow">
        <span class="newmap-icon">
        ...
        <span class="newmap-badge">۲</span>
      </div>

      <div class="newmap-card newmap-card--bottom">
        <h3>ثبت اطلاعات</h3>
    ...
    <!-- مرحله ۳ -->
    <div class="newmap-item newmap-item--step3">
      <div class="newmap-circle newmap-circle--yellow">
        <span class="newmap-icon">
        ...
        <span class="newmap-badge">۳</span>
      </div>

      <div class="newmap-card newmap-card--top newmap-card_one">
        <h3>دریافت پیامک</h3>
    ...
    <!-- مرحله ۴ -->
    <div class="newmap-item newmap-item--step4">
      <div class="newmap-circle newmap-circle--yellow">
        <span class="newmap-icon">
        ...
        <span class="newmap-badge">۴</span>
      </div>
    ...
    <!-- مرحله ۵ -->
    <div class="newmap-item newmap-item--step5">
      <div class="newmap-circle newmap-circle--yellow">
        <span class="newmap-icon">
        ...
        <span class="newmap-badge">۵</span>
      </div>
